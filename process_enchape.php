...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Actualizar el estado de enchapado a "Listo para Revisión"
    $sql = "UPDATE proyectos SET estado_corte = 'Listo para Revisión' WHERE id = ?";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("i", $id);
    $sql_insert = "INSERT INTO proyectos (nombre_pieza, pdf_url, fecha_envio, estado_corte, modulo) VALUES (?, ?, NOW(), 'Pendiente para enchape', 'Enchape')";
